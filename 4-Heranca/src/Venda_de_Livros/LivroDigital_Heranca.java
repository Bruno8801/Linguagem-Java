...
public class LivroDigital_Heranca extends Livro {
    public String linkDownload;
    public int tamanhoMB;

    // O construtor tambem precisa receber o objeto Autor criado separadamente.
    public LivroDigital_Heranca(Autor autor, float custoProducao, float precoVenda, String titulo, int paginas, String linkDownload, int tamanhoMB) {
